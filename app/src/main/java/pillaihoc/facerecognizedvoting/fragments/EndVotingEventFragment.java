 ...
 */
public class EndVotingEventFragment extends BaseFragment {


    @Bind(R.id.RecyclerViewVolunteers)
    RecyclerView RecyclerViewVolunteers;

    @Bind(R.id.btnEndEvent)
    Button btnEndEvent;

    @Bind(R.id.tvEventName)
    TextView tvEventName;

    @Bind(R.id.tvEventStartedOn)
    TextView tvEventStartedOn;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.end_voting_fragment, container, false);
        ButterKnife.bind(this, view);

        requestQueue = Volley.newRequestQueue(getActivity());
        try {
            ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("End Voting Event");
    ...
    private void endEvent() {
        ...
        CustomRequest jsObjRequest = new CustomRequest(Request.Method.POST, Constants.BASE_URL + Constants.ENDEVENT, hashMap, this.createRequestSuccessListener3(), this.createRequestErrorListener3());
        Utils.PrintErrorLog("Params", "URL" + Constants.BASE_URL + Constants.ENDEVENT + "" + hashMap);
        requestQueue.add(jsObjRequest);
    }

    private Response.ErrorListener createRequestErrorListener3() {
        dismissDialog();
    ...
    private Response.Listener<JSONObject> createRequestSuccessListener3() {
        dismissDialog();
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    if (response.has("active")) {
                        ...
                        tvEventStartedOn.setText(jsonObject.getString("eventStartTime"));
